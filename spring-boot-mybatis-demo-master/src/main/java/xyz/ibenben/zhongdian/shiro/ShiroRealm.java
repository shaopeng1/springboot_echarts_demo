package xyz.ibenben.zhongdian.shiro;
...
import xyz.ibenben.zhongdian.system.dao.UPermissionDao;
import xyz.ibenben.zhongdian.system.dao.URoleDao;
...
//        String md5Pwd = new Md5Hash("123", "lucare",2).toString();
        if (hasUser != null) {
            ...
            for (UPermission uPermission : plist) {
            	perminsStrlist.add(uPermission.getName()+uPermission.getUrl());
			}
